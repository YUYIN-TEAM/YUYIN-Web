function postData() {
    ...
    $.ajax({
      ...
      success: function (res) {
        ...
        res = res.replace("http://10.214.242.10:9881/YUYIN1004/data/input_video","http://10.214.242.10:1998/data/input_video/"+ project_name)
        console.log('after', res)
        sessionStorage.setItem("upload_video_url", res)
        window.location.href="gen-2.html";
        // alert(res);
